...
public class Product implements Serializable {
	...
	public static final String FIND_ALL = "Product.getAll";
	...
	@LazyCollection(LazyCollectionOption.FALSE) // This line to avoid lazy fetch, which may result in a null pointer when we try to access it from JSF
